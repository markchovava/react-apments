          ...
          <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
            <div className='flex items-center gap-x-4 mb-8'>
              ...
              <div>
                ...
                <Link to={house.agent.name}>View Listings</Link>
              </div>
            </div>
            <form action='' className='flex flex-col gap-y-4'>
              ...
              className='border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400'></textarea>
